...
const ChapterItem = memo(({ chapter, index, expanded, toggle }) => {
  ...
  return (
    <div className="relative pl-12 md:pl-16 group">
      ...
      <motion.div
        whileTap={{ scale: 0.98 }}
        onClick={() => hasTopics && toggle(index)}
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-4xl relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-rozha text-4xl sm:text-5xl lg:text-6xl gold-gradient-text mb-4">
            {t("chapters.title", "पुस्तकात काय आहे?")}
          </h2>

          <p className="text-slate-600 dark:text-slate-400 font-mukta text-lg">
            {t(
